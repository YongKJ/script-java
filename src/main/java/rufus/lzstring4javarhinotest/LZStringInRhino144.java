...
public class LZStringInRhino144 {
    ...
    protected static String LZ_STRING_JS_FILE_PATH = System.getProperty("user.dir") + File.separatorChar + "refence" + File.separatorChar + "lz-string-1.4.4.js";
    ...
    protected static Function FUNC_compressToEncodedURIComponent;
    protected static Function FUNC_decompressFromEncodedURIComponent;
