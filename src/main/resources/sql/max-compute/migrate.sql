CREATE
EXTERNAL TABLE IF NOT EXISTS ods_event_data
(
...
location 'jdbc:postgresql://hgpostcn-cn-lbj3pigfh06c-cn-shenzhen-internal.hologres.aliyuncs.com:80/pre_warehouse?ApplicationName=MaxCompute&currentSchema=public&preferQueryMode=simple&useSSL=false&table=ods_event_data/'
TBLPROPERTIES (
...
CREATE
EXTERNAL TABLE IF NOT EXISTS ods_device_user_info
(
    `id`                  BIGINT NOT NULL DEFAULT 0,
...
STORED BY 'com.aliyun.odps.jdbc.JdbcStorageHandler'
location 'jdbc:postgresql://hgpostcn-cn-lbj3pigfh06c-cn-shenzhen-internal.hologres.aliyuncs.com:80/pre_warehouse?ApplicationName=MaxCompute&currentSchema=public&preferQueryMode=simple&useSSL=false&table=ods_tencent_advertising_report/'
TBLPROPERTIES (
  'mcfed.mapreduce.jdbc.driver.class'='org.postgresql.Driver',
  'odps.federation.jdbc.target.db.type'='holo'
);
